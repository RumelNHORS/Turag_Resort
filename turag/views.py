...
from .models import GalleryImage, AboutSection, CarouselItem, RoomFeature, RoomOffer, Blog, SocialMediaLink
...
def index(request):
    ...
    social_media_info = SocialMediaLink.objects.first() 
...
class RoomDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['social_media_info'] = SocialMediaLink.objects.first() 
        return context
